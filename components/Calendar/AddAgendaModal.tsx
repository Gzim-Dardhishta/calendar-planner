...
//                                 // Delete only the single agenda (you'll need to specify which single agenda)
//                                 try {
//                                     const response = await axios.delete(`/api/agendas/${agendaId}`)
//                                     if (response.status === 200) {
//                                         setAgendas((prevAgendas) =>
//                                             prevAgendas.filter((agenda) => agenda._id !== agendaId)
//                                         )
